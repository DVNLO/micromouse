...
{
	LEDN_ON_L_REG_ADDRESS = PCA9685::REG_LED0_ON_L;
	LEDN_ON_H_REG_ADDRESS = PCA9685::REG_LED0_ON_H;
	LEDN_OFF_L_REG_ADDRESS = PCA9685::REG_LED0_OFF_L;
	LEDN_OFF_H_REG_ADDRESS = PCA9685::REG_LED0_OFF_H;
}
...
drive::pwm::PCA9685_LEDn_reg_addresses::PCA9685_LEDn_reg_addresses(const uint_fast8_t& output_channel)
{
	...
	LEDN_ON_L_REG_ADDRESS = static_cast<uint_fast8_t>(PCA9685::REG_LED0_ON_L + channel_address_offset);
	LEDN_ON_H_REG_ADDRESS = static_cast<uint_fast8_t>(PCA9685::REG_LED0_ON_H + channel_address_offset);
	LEDN_OFF_L_REG_ADDRESS = static_cast<uint_fast8_t>(PCA9685::REG_LED0_OFF_L + channel_address_offset);
	LEDN_OFF_H_REG_ADDRESS = static_cast<uint_fast8_t>(PCA9685::REG_LED0_OFF_H + channel_address_offset);
}
